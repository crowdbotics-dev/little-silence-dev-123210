...
## Project Structure
    ...
    ├── little_silence_dev_123210  # Django project configurations
...
1. Clone this repo and `cd little_silence_dev_123210`
...
2. Clone this repo and `cd little_silence_dev_123210`
